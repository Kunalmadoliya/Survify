...
const Service = () => {
  return (
    <section id="service" className="py-10 px-4 sm:px-6 md:py-5">
      <Container>
        <ScrollScaleReveal>
          <div className="flex flex-col p-6 sm:p-10 font-bold text-center max-w-5xl mx-auto">
            ...
            <h1 className="text-2xl sm:text-4xl md:text-5xl  text-gray-400 leading-snug flex items-center justify-center flex-wrap gap-2">
              <span className="bg-green-500 rounded-full px-2 text-black">👷</span>
              <span className="text-black">Professionals <span className="text-gray-400"> at your convenience.</span></span>
            </h1>
          </div>
        </ScrollScaleReveal>
