...
const Testimonials = () => {
  const items = [
    ...
    },
    {
      ...
      description:
        "Super friendly team and the service quality was excellent!",
      stars: "⭐⭐⭐⭐⭐",
    },
    {
      title: "Kabir Anand",
  ...
  return (
    <Container>
      <div className="bg-green-600 mb-10 mt-5 rounded-lg px-4">
        <div className="py-16">
          <h1 className="text-center text-4xl sm:text-5xl md:text-6xl font-extrabold text-neutral-800 dark:text-white">
            Here's What Our{" "}
            <span className="text-black bg-blue-500 px-3 rounded-md">Family</span> Say
          </h1>

          <DraggableCardContainer className="relative flex h-[600px] w-full items-center justify-center overflow-clip rounded-md mt-10">
            <p className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-3/4  text-center  sm:text-3xl md:text-2xl font-black text-white dark:text-white">
              Thank you Sheriyans for making me capable of building websites like this. This is my first cohort and the experience is too good, but my all-time favorite bhaiya is Ali bhaiya as always. Thank you Sheriyans and all the team 🫂🫂
            </p>
